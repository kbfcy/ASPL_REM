...
accelerate launch attacks/aspl_REM.py \
  ...
  --max_delta_a_train_steps=12 \
  --aug_sample_steps=1 \
  --checkpointing_iterations=10 \
  --learning_rate=5e-7 \
  --pgd_alpha_delta_u=5e-3 \
  --pgd_alpha_delta_a=2e-3 \
  --pgd_eps_delta_u=5e-2 \
  --pgd_eps_delta_a=2e-2 

# ------------------------- Train DreamBooth on perturbed examples -------------------------
export INSTANCE_DIR="$OUTPUT_DIR/noise-ckpt/fin"
