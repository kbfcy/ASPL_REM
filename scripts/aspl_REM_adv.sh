export EXPERIMENT_NAME="ASPL_REM_adv"
export MODEL_PATH="./stable-diffusion/stable-diffusion-2-1-base"
export CLEAN_TRAIN_DIR="outputs/ASPL_REM/n000050_ADVERSARIAL/noise-ckpt/fin" 
export CLEAN_ADV_DIR="outputs/ASPL_REM/n000050_ADVERSARIAL/noise-ckpt/fin"
