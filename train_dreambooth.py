...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        instance_data_dirs=[]
        for i in list(Path(instance_data_root).iterdir()):
            if str(i).endswith('.png') or str(i).endswith('.jpg'):
                instance_data_dirs.append(i)
        self.instance_images_path = instance_data_dirs
        ...
        if class_data_root is not None:
            ...
            class_data_dirs=[]
            for i in list(self.class_data_root.iterdir()):
                if str(i).endswith('.png') or str(i).endswith('.jpg'):
                    class_data_dirs.append(i)
            self.class_images_path = class_data_dirs
